  ...
  return (
    <Container>
      <Stack gap="sm">
        ...
        >
          <Stack gap="md">
            <Switch
              ...
              onChange={(event) => update("updatePackages", event.currentTarget.checked)}
            />
            <Divider />
            <Grid gutter="md">
              <Grid.Col span={{ base: 12, sm: 6 }}>
                <TextInput
                  ...
                  onChange={(event) => update("hostname", event.currentTarget.value)}
                />
              </Grid.Col>
              <Grid.Col span={{ base: 12, sm: 6 }}>
                <Select
        ...
        >
          <Stack gap="md">
            <Alert icon={<Info size={14} />} color="blue" variant="light" p="xs" fz="xs">
            ...
            <Grid gutter="md">
              ...
              <Grid.Col span={{ base: 12, sm: 6 }}>
                <PasswordInput
                  ...
                  onChange={(event) => update("userPassword", event.currentTarget.value)}
                />
              </Grid.Col>
            </Grid>
            <Textarea
              ...
              onChange={(event) => update("sshAuthorizedKeys", event.currentTarget.value)}
            />
          </Stack>
        </SectionCard>
        ...
        >
          <Stack gap="md">
            <Alert icon={<Info size={14} />} color="orange" variant="light" p="xs" fz="xs">
            ...
            <Grid gutter="md">
              <Grid.Col span={{ base: 12, sm: 4 }}>
                <NumberInput
                  ...
                  onChange={(value) => update("sshPort", typeof value === "number" ? value : 22)}
                  min={1}
                  max={65535}
                />
              </Grid.Col>
              <Grid.Col span={{ base: 12, sm: 8 }}>
                <Stack gap="sm" mt="lg">
                  <Switch
                    ...
                    onChange={(event) => update("disableRootLogin", event.currentTarget.checked)}
                  />
                  <Switch
          ...
          <Stack gap="lg">
            <Box>
              <Switch
                ...
                onChange={(event) => update("firewallEnabled", event.currentTarget.checked)}
              />
            ...
            <Switch
              ...
              onChange={(event) => update("fail2banEnabled", event.currentTarget.checked)}
            />
            ...
            <Switch
              ...
              onChange={(event) => update("unattendedUpgradesEnabled", event.currentTarget.checked)}
            />
          </Stack>
        </SectionCard>
        ...
        >
          <Box>
            <Switch
              ...
              onChange={(event) => update("swapEnabled", event.currentTarget.checked)}
            />
        ...
        >
          <Text fz="xs" c="dimmed">
            ...
            <Text span fz="xs" ff="monospace">
              curl wget git vim nano htop btop tmux screen build-essential jq ripgrep unzip zip net-tools dnsutils ncdu tree mtr
            </Text>
          </Text>
        </SectionCard>
        ...
        >
          <Switch
            ...
            onChange={(event) => update("installLatestPython", event.currentTarget.checked)}
          />
        </SectionCard>
        ...
        >
          <Stack gap="sm">
            <Switch
              ...
              onChange={(event) => update("dockerComposeEnabled", event.currentTarget.checked)}
            />
            <Switch
              label="Docker Buildx plugin"
              description="Multi-platform image builder"
              checked={config.dockerClientTools}
              onChange={(event) => update("dockerClientTools", event.currentTarget.checked)}
            />
          </Stack>
        </SectionCard>
        ...
        >
          <Box>
            ...
            <SegmentedControl
              ...
              onChange={(value) => update("reverseProxy", value as VpsConfig["reverseProxy"])}
              data={[
            ...
            {config.reverseProxy !== "none" && (
              <Alert icon={<Info size={14} />} color="orange" variant="light" p="xs" fz="xs" mt="sm">
        ...
        >
          <Stack gap="md">
            ...
            <Switch
              ...
              onChange={(event) => update("tailscaleAdvertiseExitNode", event.currentTarget.checked)}
            />
          </Stack>
        </SectionCard>
        ...
        >
          <Stack gap="md">
            <Switch
              ...
              onChange={(event) => update("ohMyZshEnabled", event.currentTarget.checked)}
            />
            <Collapse in={config.ohMyZshEnabled}>
              <Stack gap="sm" mt="xs">
                ...
                <Switch
                  ...
                  onChange={(event) => update("zshAutosuggestions", event.currentTarget.checked)}
                />
              </Stack>
            </Collapse>
            <Divider />
        ...
        >
          <Alert icon={<Info size={14} />} color="teal" variant="light" p="xs" fz="xs">
            After install, run <Text span ff="monospace" fz="xs">doppler login</Text> and{" "}
            <Text span ff="monospace" fz="xs">doppler setup</Text> to configure a project.
          </Alert>
        </SectionCard>
      </Stack>
    </Container>
